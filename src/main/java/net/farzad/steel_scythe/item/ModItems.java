...
public class ModItems {
    ...
    public static final Item SCYTHE = RegisterItem("scythe",
            new ScytheItem(ModToolMaterial.STEEL_INGOT,-3,10,2.5,new FabricItemSettings().group(ItemGroup.COMBAT)));
    ...
    public static final Item STEEL_INGOT = RegisterItem("steel_ingot", new Item(new FabricItemSettings().group(ItemGroup.MATERIALS)));
